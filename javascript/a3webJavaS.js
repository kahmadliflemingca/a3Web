...
// Creating function to manipulate Docoument objects from W3 school when a button is clicked -AK//
// Kept same format, mainpulating the ID's that it interacts with, and nested with clock function//
...
function myFunction() {
  ...
  /// Variable reinitiates the myTimer function every second so the clock keeps updating -AK///
...
function myTimer() {
  ...
  document.getElementById("showDate").innerHTML = timeVariable.toLocaleDateString(); /// Breakds down the date method and takes just the date ////
}
}
